# Bus_Stop_Tree_Coverage_Evaluator
This repository contains the script for a tool that identifies bus stops in Washington, DC that are in need of additional shade and suitable for tree planting.
